...
//         const userProgress = await fetchProgressFromFirestore(userName, selectedCourseId);
...
//               <div
//                 style={{
//                   width: `${progress ? (progress.currentModuleIndex / 10) * 100 : 0}%`,
//                 }}
//                 className="bg-blue-500 h-full rounded-full text-center text-white text-sm"
//               >
//                 {progress ? Math.round((progress.currentModuleIndex / 10) * 100) : 0}%
//               </div>
//             </div>
//             <p className="text-lg mb-6">Keep pushing forward and embrace every challenge!</p>
//           </div>
//         ) : (
//           <p className="text-lg mb-6">No course selected. Get started to begin your journey!</p>
//         )}
//         <Link href="/courses">
